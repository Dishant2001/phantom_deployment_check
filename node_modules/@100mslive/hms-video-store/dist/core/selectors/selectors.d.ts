 ...
 */
export declare const selectRoomID: import("reselect").OutputSelector<HMSStore, string, (res: HMSRoom) => string>;
/**
 * @internal
 */
 ...
 */
export declare const selectPeerCount: import("reselect").OutputSelector<HMSStore, number, (res1: boolean | undefined, res2: HMSRoom) => number>;
/**
 ...
 */
export declare const selectLocalPeerName: import("reselect").OutputSelector<HMSStore, string, (res: HMSPeer) => string>;
/**
 * Select the role name of your local peer.
 */
export declare const selectLocalPeerRoleName: import("reselect").OutputSelector<HMSStore, string | undefined, (res: HMSPeer) => string | undefined>;
/**
