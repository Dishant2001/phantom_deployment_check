...
joinBtnGuest.addEventListener("click", async () => {
  ...
  hmsActions.join({
    userName: document.getElementById("name").value,
    authToken: guest_key,
    // authToken: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..T-8NS9pF-AT8rSG8N32Dpd6kHwlBJdMci9T7qNmLxzM',
    settings: {
      isAudioMuted: true,
      isVideoMuted: true
    },
