  ...
  if (peers.length != 0 && queue.size() != 0) {
    ...
    if (top_guest.videoTrack) {
      const video_guest = h("video", {
        ...
        muted: true,
        playsinline: true,
        style: "position:absolute;top:0;margin:auto;transform: scale(-1, 1); filter:"+top_guest.isLocal?"FlipH":"none"+";width:100%;aspect-ratio:16/9;object-fit:cover;z-index:-100;border-radius: 24px;"
      });
