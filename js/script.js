...
let queue = new Queue();
  ...
  joinBtn.addEventListener("click", () => {
    hmsActions.join({
      ...
      // authToken: host_key,
      authToken:"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..RJb5sf8fpkxAYopohCeSauX_5I4px83ag-RjsyKmCsI",
      settings: {
        isAudioMuted: false,
        isVideoMuted: false
    },
  ...
  joinBtnGuest.addEventListener("click", async() => {
    ...
    hmsActions.join({
      ...
      authToken:'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..HUafFmrqucvkoNhCZ3vD97d-pUft7OglyCRlLuTC8qk',
      settings: {
        isAudioMuted: true,
        isVideoMuted: true
    },
